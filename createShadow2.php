...
<div id="content">
	...
	<table id="content_table">
		<tr>
			...
			<td id="main">
				<div class="block">
					<div class="title"><p>Convert to Shadow - <a href="checkPokemon2.php?<?php echo $urlValidation ?>">Go Back</a></p></div>
                ...
                <?php }else {
					$db = connect_To_Database();
						...
						?>
					<div class="content">
                    <p>You have (<?php echo $howManyCoins ?>) Sam and Dan Coins and (<?php echo $howManyDailyCoins ?>) Daily Coins to use in Converting your Pokemon to Shadow. <a href="http://samdangames.blogspot.com/p/get-snd-coins.html">Click here to get more Sam and Dan coins.</a></p>
						<p>Here is a list of your regular Pokemon from this profile <b>(Shiny cannot be converted to Shadow)</b>, click on Convert to Shadow <b>(plus removed any hacked tag and Hall of Fame Tag!)</b> to use up 10 Snd Coins or 800 Daily Coins and convert your Pokemon into shadow!</p>
					</div>
				</div>
                <?php 
				echo $whichDB;
...
if ($page) {
	...
	for ($i=1; $i<=$hmp; $i++) {
		...
		$extra = 'Convert Shadow: <a href="createShadow2Actual.php?'.$urlValidation.'&pokeID='.$pokeID.'">(10) Snd Coins</a> or <a href="createShadow2Actual.php?'.$urlValidation.'&pokeID='.$pokeID.'&daily=1">(800) Daily Coins</a>';
